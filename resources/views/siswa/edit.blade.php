            ...
            <div class="card-body p-4">
                <form action="{{ route('siswa.update', $siswa->id_siswa) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="nisn" id="nisn" class="form-control @error('nisn') is-invalid @enderror" value="{{ old('nisn', $siswa->nisn) }}" placeholder="Masukkan NISN" required maxlength="10">
                        @error('nisn')
